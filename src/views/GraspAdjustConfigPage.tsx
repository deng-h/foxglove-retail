...
const CONFIG_PATH = "/retail/grasp-adjust-config/config.yml";
const CONFIG_DIR = "/retail/grasp-adjust-config/";
const CONFIG_FILENAME = "config.yml";

// 配置 Monaco Editor 使用本地导入的实例，避免 CDN 加载和 CSP 限制
loader.config({ monaco });

export default function GraspAdjustConfigPage(): ReactElement {
